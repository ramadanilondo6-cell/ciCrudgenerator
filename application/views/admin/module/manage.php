        ...
        <div class="ibox ">
            ...
            <div class="col-sm-12 white-bg ">
                <div class="box box-info">
                    ...
                    <!-- form start -->
                    <form action="<?php echo base_url(); ?>admin/module/add" class="form-horizontal " method="post" enctype="multipart/form-data" id="current_form">
                        ...
                        <tbody>
                            <?php foreach ($modules as $module): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editModuleModal" data-module-name="<?php echo $module; ?>">Edit</a>
                                        <a href="<?php echo base_url() . 'admin/module/delete_module/' . $module; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this module?');">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<!-- Edit Module Modal -->
<div class="modal fade" id="editModuleModal" tabindex="-1" role="dialog" aria-labelledby="editModuleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="editModuleModalLabel">Edit Module</h4>
            </div>
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>admin/module/edit_module" method="post">
                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    <input type="hidden" name="module_name" id="edit_module_name">
                    <div class="form-group">
                        <label for="new_module_name">New Module Name</label>
                        <input type="text" class="form-control" id="new_module_name" name="new_module_name" required>
                    </div>
                    <div class="form-group">
                        <label for="new_icon">New Icon</label>
                        <input type="text" class="form-control" id="new_icon" name="new_icon" required>
                    </div>
    ...
    <script type="text/javascript">
        $('#editModuleModal').on('show.bs.modal', function (event) {
            ...
            var moduleName = button.data('module-name') // Extract info from data-* attributes
            var modal = $(this)
            modal.find('.modal-title').text('Edit Module ' + moduleName)
            modal.find('#edit_module_name').val(moduleName)
        })
    </script>
    <script type="text/javascript">
